...
The identification of these variables can help narrow the focus of clinical care by allowing physicians to predict the health and mortality of patients based on fewer clinical features. Creating more concise patient profiles to address the health outcomes of heart failure patients can alleviate the social and structural burdens this disease has on communities around the world. \vspace{0.5cm}
...
```{r}
heart.data <- read.csv('https://raw.githubusercontent.com/ploewen/Stat_306_Project/389349ca0739a7d135d1c3ccb59e0abf991684fa/heart_failure_data.csv', header = TRUE)
